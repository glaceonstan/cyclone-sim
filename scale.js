...
Scale.stareiScale =  new Scale({
    displayName: 'Saffir-Simpson (Starei)',
    colorSchemeDisplayNames: ['Starei'],
    flavorDisplayNames: ['Hurricane','Typhoon','Cyclone'],
    classifications: [
        {
            threshold: 0,
            color: ['#366fff'],
            subtropicalColor: ['#8636ff'],
            symbol: 'D',
            arms: 0,
...
Scale.saffirSimpson = new Scale({
    ...
    classifications: [
        {
            threshold: 0,
            color: ['rgb(20,20,230)','#5ebaff','#5ebaff','#366fff'],
            subtropicalColor: ['rgb(60,60,220)','#5ebaff','#5ebaff','#8636ff'],
            symbol: 'D',
            arms: 0,
            stormNom: 'Tropical Depression',
            subtropicalStormNom: 'Subtropical Depression',
...
Scale.IMD = new Scale({
    ...
    classifications: [
        ...
        {
            threshold: 28,
            color: ['rgb(20,20,230)','#5ebaff','#5ebaff','#5ebaff'],
            subtropicalColor: ['rgb(60,60,220)','#5ebaff','#5ebaff','#5ebaff'],
            symbol: 'DD',
            arms: 0,
